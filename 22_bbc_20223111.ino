...
// Servo adjustment
#define _DUTY_MAX 2001  // Servo angle: D degree
#define _DUTY_NEU 1351  // Servo angle: 0 degree
#define _DUTY_MIN 628   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 74 // Replace with |D - E| degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 1099 + (-5.86)*a_value + 0.0109*a_value*a_value + (-6.9E-06 * a_value*a_value*a_value);
}
